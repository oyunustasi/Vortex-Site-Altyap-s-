...
module.exports.run = async (client, message, args) => {
    ...
    const embed = new Discord.MessageEmbed()
        ...
        .setDescription("**[Vote for the bot named " + b.username + "#" + b.discrim + " isimli bota oy ver.](https://vortex-botlistcodeshare.glitch.me/bot/" + b.botID + "/vote)**")
        ...
        .addField("Sahipler", `<@${b.ownerID}>\n${coowner.replace("<@>", "")}`, true)
        .addField("Linkler", `[Invite](https://discord.com/oauth2/authorize?client_id=${b.botID}&scope=bot&permissions=8)${website}${discord}${github}`, true)
